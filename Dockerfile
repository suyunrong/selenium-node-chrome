...
RUN wget -q -O - https://dl-ssl.google.com/linux/linux_signing_key.pub | apt-key add - \
  ...
  && apt-get update -qqy \
  && if [$CHROME_VERSION == "google-chrome-stable"]; then apt-get -qqy install ${CHROME_VERSION:-google-chrome-stable}; else wget --no-verbose -O /tmp/google-chrome-stable_current_amd64.deb https://github.com/suyunrong/GoogleChrome/raw/master/$CHROME_VERSION/google-chrome-stable_current_amd64.deb; fi \
